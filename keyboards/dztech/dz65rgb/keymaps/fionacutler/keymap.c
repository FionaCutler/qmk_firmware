...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_LAYER1] = LAYOUT_65_ansi( /* FN */
		    ...
		    KC_CAPSLOCK,   RGB_TOG,  KC_UP, RGB_HUI,RGB_HUD, RGB_TOG, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, KC_PSCR, KC_SLCK,  KC_PAUS, RESET,KC_PGUP,\
			KC_LCTL,       KC_LEFT,  KC_DOWN, KC_RIGHT,KC_TRNS, KC_TRNS, RGB_SAI, RGB_MOD, RGB_HUI, RGB_HUD, KC_TRNS,  KC_TRNS,          EEP_RST,  KC_PGDN,\
		    KC_LSFT,       KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, RGB_SPI, RGB_SPD, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,          KC_VOLU,  KC_MUTE,\
...
>>>>>>> d5393d1afc51c79da225943213206c4d5813f686
};
