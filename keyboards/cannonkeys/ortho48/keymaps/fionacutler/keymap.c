...
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    RGB_TOG, KC_LCTL, KC_LALT, KC_LGUI, MO(_LOWER),   KC_SPC,  KC_BSPC,  MO(_RAISE),   KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT
),
...
[_GAMING] = LAYOUT_ortho_4x12(
    ...
    KC_ESC,  KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,  KC_F5,   KC_F6,   KC_F7,   KC_F8,  XXXXXXX,
    KC_LSFT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,  KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_RSFT,
    XXXXXXX, KC_LCTL, KC_LALT, KC_C,    KC_B, KC_SPC,    KC_C,   XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
